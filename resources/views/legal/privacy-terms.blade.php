    ...
    <div class="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        <article class="reveal site-panel space-y-10 p-6 sm:p-8">
            ...
            <section class="space-y-5 text-sm leading-relaxed text-slate-700 dark:text-slate-300">
                <h2 class="text-lg font-bold text-slate-950 dark:text-slate-50">{{ __('legal.privacy_heading') }}</h2>
                <p>{{ __('legal.privacy_intro') }}</p>

                <div class="space-y-1">
                    <h3 class="font-semibold text-slate-950 dark:text-slate-100">{{ __('legal.privacy_use_title') }}</h3>
                    <p>{{ __('legal.privacy_use_body') }}</p>
                </div>
                <div class="space-y-1">
                    <h3 class="font-semibold text-slate-950 dark:text-slate-100">{{ __('legal.privacy_sharing_title') }}</h3>
                    <p>{{ __('legal.privacy_sharing_body') }}</p>
                </div>
                <div class="space-y-1">
                    <h3 class="font-semibold text-slate-950 dark:text-slate-100">{{ __('legal.privacy_content_title') }}</h3>
                    <p>{{ __('legal.privacy_content_body') }}</p>
                </div>
                <div class="space-y-1">
                    <h3 class="font-semibold text-slate-950 dark:text-slate-100">{{ __('legal.privacy_screen_title') }}</h3>
                    <p>{{ __('legal.privacy_screen_body') }}</p>
                </div>
            </section>

            <section class="space-y-5 text-sm leading-relaxed text-slate-700 dark:text-slate-300">
                <h2 class="text-lg font-bold text-slate-950 dark:text-slate-50">{{ __('legal.terms_heading') }}</h2>

                <div class="space-y-3">
                    <h3 class="font-semibold text-slate-950 dark:text-slate-100">{{ __('legal.terms_s1_title') }}</h3>
                ...
                <div class="space-y-3">
                    <h3 class="font-semibold text-slate-950 dark:text-slate-100">{{ __('legal.terms_s2_title') }}</h3>
                    <ul class="list-disc space-y-2 ps-5">
                ...
                <div class="space-y-3">
                    <h3 class="font-semibold text-slate-950 dark:text-slate-100">{{ __('legal.terms_s3_title') }}</h3>
                ...
                <div class="space-y-3">
                    <h3 class="font-semibold text-slate-950 dark:text-slate-100">{{ __('legal.terms_s4_title') }}</h3>
                    <ul class="list-disc space-y-2 ps-5">
