@php
    ...
    $sections = [
        'overview' => [
            'label' => __('admin.nav.section_overview'),
            'items' => [
        ...
        'students' => [
            'label' => __('admin.nav.section_students'),
            'items' => [
        ...
        'content' => [
            'label' => __('admin.nav.section_content'),
            'items' => [
        ...
        'system' => [
            'label' => __('admin.nav.section_system'),
            'items' => [
    ...
    <div class="flex h-full min-h-0 flex-col">
        <div class="border-b border-white/10 px-4 py-5">
            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3">
                ...
                @endif
                <div class="min-w-0">
                    <div class="truncate text-sm font-semibold text-white">{{ config('app.name') }}</div>
        ...
        <nav class="admin-sidebar-nav flex-1 overflow-y-auto overscroll-contain px-2 py-4">
            @foreach ($sections as $sectionKey => $section)
                <div class="admin-nav-section px-3 pb-1.5 pt-4 text-[10px] font-semibold uppercase tracking-wider text-white/40" data-nav-section="{{ $sectionKey }}">
                    {{ $section['label'] }}
                </div>
                <div class="space-y-1">
