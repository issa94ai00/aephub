...
<?php $__env->startSection('content'); ?>
    <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <div class="admin-card p-4">
            ...
            <div class="mt-2 text-2xl font-bold text-white"><?php echo e($stats['connected_users_count']); ?></div>
            <div class="mt-1 text-[11px] text-emerald-200/80"><?php echo e(__('admin.user_reports.active_devices')); ?>: <?php echo e($stats['active_devices_count']); ?></div>
            <a href="<?php echo e(route('admin.user-reports.index')); ?>" class="mt-2 inline-block text-[11px] text-emerald-200 hover:underline"><?php echo e(__('admin.user_reports.view_report')); ?></a>
        </div>
        <div class="admin-card p-4">
...
<?php echo $__env->make('admin.spa-inner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Damatech\Desktop\AEP\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>